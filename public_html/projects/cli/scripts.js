...
function addToUserHistory(line) {
  $("#console-log tr").eq(-2).before(
    "<tr>" +
    "<td id='input-marker' style='width:1%; font-weight:400; color:#FFDD00'>>&nbsp;</td>" +
    "<td id='user-record' style='font-weight:400; color:#FFDD00'>" + line + "</td>" +
    "</tr>"
  );
}
...
function addToMachineHistory(line) {
  $("#console-log tr").eq(-2).before(
    "<tr>" +
    "<td id='input-marker style='width:1%'>&nbsp;&nbsp;</td>" +
    "<td id='machine-record'>" + line + "</td>" +
    "</tr>"
  );
}
